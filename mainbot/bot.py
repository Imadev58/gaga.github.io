...
async def log_djoin(ctx, server_id, server_name):
    ...
    log_channel = bot.get_channel(1289586694642860085)  # Replace with your log channel ID
...
async def djoin(ctx, server_id: int):
    ...
    if ctx.channel.id != 1289379086841544754:
...
async def add(ctx):
    embed = discord.Embed(
        title="🔗 **Invite**",
        description="**🌟 URL** [🌐 ADD](https://discord.com/oauth2/authorize?client_id=1240064584023277638&permissions=8&integration_type=0&scope=bot) THEN ADD [🌐 2nd bot ADD](https://discord.com/oauth2/authorize?client_id=1288821471245893633&permissions=8&integration_type=0&scope=bot) you need both Bots for our member bot to work!!!!!",
        color=discord.Color.blue()
    )
    embed.set_footer(text="💫 Powered by 🌕 .gg/night")
    await ctx.send(embed=embed)
